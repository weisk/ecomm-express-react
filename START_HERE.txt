**** Major Component and Style updates were done and so far everything seems to be working fine but make sure to yarn install, or npm install if you get issues ****

*** Furhter Testing should be done to ensure that all functions are working correctly, feel free to reach out if something is broken ***

** Updated Material UI to the newest version and fixed components that were affected by the change **

* I will continue to work on this project so make sure you check for the latest changes, also I'm aware of the warning for ReactSwipableView. The creator doesn't seem to want to update the package further so you may want to change it yourself or find a better solution *

Here is a quick start on how to get a store up and running. 
...
You can go ahead and change the ADMIN_PW to whatever you like, this the password used to get into the admin section of the app. You can go ahead and make SESSION_SECRET as well. Make it hard to guess.
